...
class SendMediaService:Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        images = intent.getStringArrayListExtra("media") as ArrayList<String>
        ...
        for (a in images.indices) {
            ...
            val fileName =  compressImage("file://" + images[0])
    ...
    private fun compressImage(fileName: String): String? {
        ...
        if (!file.exists())
            file.mkdirs()
     val temp =  SiliCompressor.with(this).compress(fileName, file, false)
        return temp
    }
    ...
    private fun uploadImage(fileName: String) {
        ...
        val storageReference = FirebaseStorage.getInstance()
            .getReference(chatID + "/Media/Image/" + appUtil.getUID() + "/" + System.currentTimeMillis())
