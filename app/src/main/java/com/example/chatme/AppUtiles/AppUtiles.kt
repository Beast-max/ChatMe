package com.example.chatme.AppUtiles
...
class AppUtiles {
    ...
    fun updateonlinestatus(status:String){
        val databaseRefrence = FirebaseDatabase.getInstance().getReference("Users").child(getUID()!!)
        val map=HashMap<String,Any>()
        map["online"] = status
            databaseRefrence.updateChildren(map)
    }
}